...
from .views import BasicModuleView, RetrieveModuleView,NoNormalWorkTaskTypeView,VarietyView, WorkModelTablesDownloadView
...
basic_blp.add_url_rule('model-tables/', view_func=WorkModelTablesDownloadView.as_view(name='modeltables'))