...
from plates.customer import customer_blp
...
static_folder = os.path.join(BASE_DIR, 'fileStore')

app = Flask(__name__, static_url_path='/fileStore', static_folder=static_folder)
